...
const ChurchLocation = () => {
  return (
    <div className="relative w-full h-screen pt-[50px] px-[30px] lg:p-[50px] bg-[#fff]">
      <div className="h-full overflow-y-scroll pb-[40px] flex flex-col items-center gap-[30px]">
        ...
        <div className="text-center">
          ...
          <p>
            From ikorodu garage, take a maruwa to ladegboye/ elepe and alight at
            Ladegboye junction. Cross to the other side and follow the road up
            to Foursquare Gospel church, Blue roof on the left hand side.
          </p>
          <p className="text-2xl mt-[15px] font-[500]">To Reception:</p>
          <p className="">
            From ikorodu garage, join bus going to gbaga or elepe and drop at
            Epic Event Center Cele, it's by the road side.
          </p>
        </div>
